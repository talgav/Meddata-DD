...
```{r}
rm(list = setdiff(ls(), c("medata","medata_raw","med_seas")))
...
# save(medata, file = "G:\\My Drive\\PHD\\chapter 3 MPA dd\\Meddata-DD\\clean output data\\Clean_Medata.Rdata")

# write.csv(medata,"G:\\My Drive\\PHD\\chapter 3 MPA dd\\Meddata-DD\\clean output data\\Clean_Medata.csv")
```
...
```{r}
#save(unique_coords,file = "G:\\My Drive\\PHD\\chapter 3 MPA dd\\Meddata-DD\\clean output data\\unique_coords.Rdata")

#write.csv(unique_coords,"G:\\My Drive\\PHD\\chapter 3 MPA dd\\Meddata-DD\\clean output data\\unique_coords.csv")
