...
```{r setup data}
med_raw <- read_csv("data/all_uvc_data_101119.csv", na = c("", "NA")) # na() is used to make sure all blanks and all NAs are counted as NA.
...
Species with no available trait data were removed from traits-related analysis:
